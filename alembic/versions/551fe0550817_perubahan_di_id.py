...
Revision ID: 551fe0550817
Revises: 4843fb3e4051
Create Date: 2025-09-19 15:38:12.094462
...
revision: str = '551fe0550817'
down_revision: Union[str, Sequence[str], None] = '4843fb3e4051'
...
def upgrade() -> None:
    ...
    op.alter_column('customer', 'id_customer',
               ...
               existing_server_default=sa.text("nextval('customer_id_customer_seq'::regclass)"))
    ...
    op.alter_column('meja', 'location',
               ...
               nullable=False)
    op.alter_column('meja', 'status',
               existing_type=postgresql.ENUM('tersedia', 'tidaktersedia', name='status_enum'),
               server_default=None,
               existing_nullable=False)
...
def downgrade() -> None:
    ...
    op.alter_column('reservation', 'status',
               existing_type=postgresql.ENUM('pending', 'confirmed', 'completed', 'cancelled', name='reservationstatusenum'),
               server_default=sa.text("'pending'::reservationstatusenum"),
               nullable=True)
    op.alter_column('reservation', 'notes',
    ...
    op.alter_column('payment', 'status',
               existing_type=postgresql.ENUM('unpaid', 'paid', 'refunded', name='paymentstatusenum'),
               server_default=sa.text("'unpaid'::paymentstatusenum"),
               nullable=True)
    op.alter_column('payment', 'method',
               existing_type=postgresql.ENUM('cash', 'card', 'e_wallet', name='paymentmethodenum'),
               server_default=sa.text("'cash'::paymentmethodenum"),
               nullable=True)
    op.alter_column('payment', 'amount',
    ...
    op.alter_column('meja', 'status',
               existing_type=postgresql.ENUM('tersedia', 'tidaktersedia', name='status_enum'),
               server_default=sa.text("'tersedia'::status_enum"),
               existing_nullable=False)
    op.alter_column('meja', 'location',
               existing_type=postgresql.ENUM('indoor', 'outdoor', 'vip', name='location_enum'),
               nullable=True)
